...
int servoLeftmax = 110; // Turn Left // 105 (Old value)
int servoRightmax = 60; // Turn Right // 65 (Old Value)
...
int CAR_SPEED_T = 180; // Car Speed for Turning 255 is Max. , Min. is 70            // 120 is good !!!!
